package com.bank.bian.capitalmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Capital Plan Management Plan".
 *
 ...
 * to its asset type (Capital Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Capital Plan Management Plan";
